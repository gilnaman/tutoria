...
<div class="wrapper">
  ...
  {{--     <form action="#" method="get" class="sidebar-form">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        {{-- <li class="active">
          <a href="{{url('profesor/cargas')}}"><i class="fa fa-link"></i> <span>Grupos</span></a>
        </li>
         --}}
        <li>

          <a href="{{url('servicios/alumnado')}}"><i class="fa fa-link"></i> Boletas ENERO- ABRIL 19<span></span></a>
 ...
 --}}
         <a href="#"><i class="fa fa-link"></i> Control de entregas<span></span></a>
        </li>
