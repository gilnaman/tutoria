...
class ProfesorController extends Controller
{
...

    {
        ...
        $alumnos = DB::Select("SELECT alumnos.matricula,alumnos.apellidop,alumnos.apellidom,alumnos.nombre
            ...
            WHERE alumnos_grupo.periodo='2020A' and alumnos_grupo.clave_grupo='$clavegrupo'
...
{ 
    ...
    //$resultado = mysql_query("SELECT * FROM lista");
        ...
        foreach($alumnos as $alumno)
        {
            ...
            $pdf->Cell(72,3.4,utf8_decode($nombre_alumno),1,0,'L');
            $pdf->Cell(6.5,3.4,'',1);
            $pdf->Cell(6.5,3.4,'',1);
            $pdf->Cell(6.5,3.4,'',1);
            $pdf->Cell(6.5,3.4,'',1);
        ...
        while($ix < 40)
        {
            ...
            $pdf->SetFont('Arial','B',7);
            $pdf->Cell(5,3.4,$ix,1,0,'C');
            $pdf->Cell(20,3.4,'',1,0,'C');
            $pdf->Cell(72,3.4,'',1,0,'L');
            $pdf->Cell(6.5,3.4,'',1);
            $pdf->Cell(6.5,3.4,'',1);
            $pdf->Cell(6.5,3.4,'',1);
            $pdf->Cell(6.5,3.4,'',1);
